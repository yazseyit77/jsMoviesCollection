...
Review.create(rating: 5, comment: "Great Movie I've ever watched!", movie_id: 3, user_id: 1)
Review.create(rating: 4, comment: "Nice Movie!", movie_id: 6, user_id: 1)
Review.create(rating: 5, comment: "Amazing action movie, wow!", movie_id: 9, user_id: 1)